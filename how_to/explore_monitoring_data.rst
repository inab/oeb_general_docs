...
.. Note::
  See section `Technical Benchmarking Data`__ to learn more on what benchmarking metrics are available, how are they collected or computed, or what are the tools source registries.
